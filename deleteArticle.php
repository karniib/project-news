...
<body>
    <div class="container mt-5">
        <div class="alert alert-danger">
            <h4 class="alert-heading">Delete Article</h4>
            <hr>
            <p class="mb-0">Are you sure you want to delete this article?</p>
        </div>
        <div class="text-center">
            <a href="deleteArticle.php?id=<?= $id ?>&confirm=yes" class="btn btn-danger">Yes, Delete</a>
            <a href="displayArticles.php" class="btn btn-secondary">Cancel</a>
        </div>
    </div>
